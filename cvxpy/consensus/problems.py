...
# TODO: Remove when package is properly compiled
import sys
sys.path.insert(0, '/home/anqi/Documents/software/cvxpy/cvxpy/consensus')
from consensus import consensus
# from cvxpy.consensus import consensus
